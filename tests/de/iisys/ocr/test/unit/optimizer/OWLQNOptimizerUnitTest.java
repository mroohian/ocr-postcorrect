...
public class OWLQNOptimizerUnitTest extends BaseTest {
    ...
    public void testOptimizer2D() {
        ...
        IOptimizer optimizer = new OWLQNOptimizer(function2D);
        optimizer.optimize();
