...
import de.iisys.ocr.test.core.graph.RemoteGraphDBUnit;
...
/**
 * RemoteGraphDBPerformanceTest
 * de.iisys.ocr.test.performance.graph
 * Created by reza on 04.09.14.
 */
public class RemoteGraphDBPerformanceTest extends BaseTest {
    private static WordPOSCorpaUnit mWordPOSCorpaUnit;
    private static RemoteGraphDBUnit mGraphDBUnit;

    @BeforeClass
    public static void setup() throws IOException, ClassNotFoundException {
        mWordPOSCorpaUnit = new WordPOSCorpaUnit(mPOSAlphabetFile, mWordAlphabetFile, mWordPOSMappingFile);
        mGraphDBUnit = new RemoteGraphDBUnit(mRemoteServer, mRemoteDbName, mRemoteUser, mRemotePassword, false);
    }
